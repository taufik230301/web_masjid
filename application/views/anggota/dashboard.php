...
<head>
    <?=$this->load->view('anggota/components/header');?>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?=$this->load->view('anggota/components/navbar');?>

        <?=$this->load->view('anggota/components/sidebar');?>
    ...
    <?=$this->load->view('anggota/components/js');?>
</body>
