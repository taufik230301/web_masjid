               ...
               with font-awesome or any other icon font library -->
                 <li class="nav-item menu-open">
                     <ul class="nav nav-treeview">
                         ...
                         <li class="nav-item">
                             <a href="<?=base_url();?>Dashboard/view_anggota" class="nav-link">
                                 <i class="nav-icon fas fa-tachometer-alt"></i>
                                 <p class="text">Dashboard</p>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="<?=base_url();?>Kas/view_anggota" class="nav-link">
                                 <i class="nav-icon fas fa-book"></i>
                                 <p>Kas</p>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a href="<?=base_url();?>Iuran/view_anggota" class="nav-link">
                         ...
                         <li class="nav-item">
                             <a href="<?=base_url();?>Kematian/view_anggota" class="nav-link">
