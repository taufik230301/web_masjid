...
<head>
    <?=$this->load->view('bendahara/components/header');?>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?=$this->load->view('bendahara/components/navbar');?>

        <?=$this->load->view('bendahara/components/sidebar');?>
    ...
    <?=$this->load->view('bendahara/components/js');?>
</body>
