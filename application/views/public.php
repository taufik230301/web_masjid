...
<body>
        ...
        <section id="team" class="team">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="<?=base_url();?>assets/public/assets/img/team/team-1.jpg" alt="">
                            <h4>Walter White</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="<?=base_url();?>assets/public/assets/img/team/team-2.jpg" alt="">
                            <h4>Sarah Jhinson</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="<?=base_url();?>assets/public/assets/img/team/team-3.jpg" alt="">
    ...
    <script src="<?=base_url();?>assets/public/assets/vendor/waypoints/noframework.waypoints.js"></script>
